...
| `tests/fixtures/synthetic-drain/` | Two-issue micro-feature template the maintainer installs into `.scratch/synthetic-drain/` for the loop's live demo. Reused by slice 08. See its README for the runbook. |
